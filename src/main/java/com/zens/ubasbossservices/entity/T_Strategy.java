 ...
 * @version 1.0
 */
public class T_Strategy extends Model<T_Strategy> {

	private static final long serialVersionUID = 1L;
	public static T_Strategy dao = new T_Strategy();

	public static final String tableName = TableMapping.me().getTable(T_Strategy.class).getName();
